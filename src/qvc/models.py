...
import qvc.attentions as attentions
import qvc.commons as commons
import qvc.modules as modules
from qvc.commons import get_padding, init_weights
from qvc.pqmf import PQMF
from qvc.stft import TorchSTFT
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.enc_p = PosteriorEncoder(
            ssl_dim, inter_channels, hidden_channels, 5, 1, 16
        )
