...
import qvc.commons as commons
from qvc.mel_processing import spec_to_mel_torch, spectrogram_torch
from qvc.utils import load_filepaths_and_text, load_wav_to_torch, transform
...
class TextAudioSpeakerLoader(torch.utils.data.Dataset):
    ...
    def __init__(self, audiopaths, hparams):
        ...
        self.ssl_mode = hparams.model.ssl_mode
    ...
    def _get_feature(self, filename):
        ...
        if self.ssl_mode == "whisper_large_v2":
            weo_filename = filename.replace(".wav", "_whisper_large_v2_ppg.npy")
        elif self.ssl_mode == "hubert":
            weo_filename = filename.replace(".wav", "_hubert_ppg.npy")
        else:
    ...
    def get_audio(self, filename):
        c, spec, audio_norm = self._get_feature(filename)
        return c, spec, audio_norm
